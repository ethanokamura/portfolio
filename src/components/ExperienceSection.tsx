...
export default function ExperienceSection({ experience, reverse }: ExperienceSectionProps) {
  return (
      ...
      <div className={`max-w-[1200px] mx-auto flex flex-col-reverse gap-20 items-center ${
        ...
        <div className="w-full">
          ...
          <div className='flex items-start gap-4 py-4'>
            <h2 className="text-6xl py-2 font-bold bg-linear-to-br from-text to-accent 
            ...
            <a href={experience.url} target='_blank'>
              <FaArrowUpRightFromSquare size={24} className='text-accent mt-6'/>
            </a>
          </div>
        ...
        {/* Visual */}
        {experience.photoUrl == '' ?
            <div className="mx-auto md:mx-0 w-72 md:w-full h-72 md:h-full aspect-square bg-linear-to-br from-purple to-cyan bg-size-[200%_200%]
              ...
              <span className="text-2xl text-text font-semibold relative z-10 
            ...
            <div className="max-w-72 md:max-w-full mx-auto md:mx-0">
              <img src={`/${experience.photoUrl}`} alt={experience.photoAlt} className='rounded-[20px] ring-1 ring-background/50 shadow-xl hover:shadow-2xl shadow-black/50 hover:scale-[105%] ease-in duration-100'/>
            </div>
          }
      </div>
    </section>
